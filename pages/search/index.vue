...
export default {
  ...
  head () {
    return {
      ...
      meta: [
        { hid: 'description', name: 'description', content: this.$route.query.keyword + 'を含むユーザー | VRCSnap!' },
        { hid: 'og:type', property: 'og:type', content: 'article' },
        { hid: 'og:title', property: 'og:title', content: this.$route.query.keyword + 'を含むユーザー | VRCSnap!' },
        { hid: 'og:description', property: 'og:description', content: this.$route.query.keyword + 'を含むユーザー | VRCSnap!' },
        ...
        { hid: 'twitter:title', name: 'twitter:title', content: this.$route.query.keyword + 'を含むユーザー | VRCSnap!' },
        { hid: 'twitter:description', name: 'twitter:description', content: this.$route.query.keyword + 'を含むユーザー | VRCSnap!' },
        { hid: 'twitter:image', name: 'twitter:image', content: 'https://vrcsnap.com/ogp/mainLogo.jpg' },
        { hid: 'twitter:image:alt', name: 'twitter:image:alt', content: this.$route.query.keyword + 'を含むユーザー | VRCSnap!' },
